...
$(document).ready(function () {
  ...
  */
  ...
  $('#text-truncate').find('.output-js').html(cssRulesMajadc.getCssStyleRules(bootstrapCssFile, '.text-truncate')); // text-wrapping
  ...
  var spacingClasses = $('#utilities-spacing>ul').children('.item-us'); // function sets data-selected on elements
  ...
  spacingClasses.setSelectedData(); //function sets data-style-rules on elements

  $.fn.setStyleRulesToSpacingClasses = function () {
    $(this).each(function () {
      var id = $(this).attr('id');
      $(this).data('data-style-rules', cssRulesMajadc.getCssStyleRules(bootstrapCssFile, ".".concat(id.charAt(0) + id.substring(2))));
    });
  };

  spacingClasses.setStyleRulesToSpacingClasses(); //function shows style rules on page
  ...
  spacingClasses.showStyleRulesForSpacingClasses(); // functions sets data-selected on true according user choice
  ...
  $('.utilities-spacing-reset').click(function (e) {
    ...
    $('.us-title').show(); //animation for scrollspy
