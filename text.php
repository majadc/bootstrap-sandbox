...
<div class="container">
      ...
      <div class="row">
        ...
        <header class="row">
          ...
          <div class="col-sm text-right align-self-end"><a class="btn btn-primary" href="https://getbootstrap.com/docs/4.1/utilities/text/" target="_blank">Bootstrap Text</a></div>
        </header>
