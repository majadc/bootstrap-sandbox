    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <header id="top" class="row">
          ...
          <div class="col-sm text-right align-self-end"><a class="btn btn-primary" href="https://getbootstrap.com/docs/<?php echo $MAJADC_BOOTSTRAP_VERSION; ?>/content/code/" target="_blank">Bootstrap Code</a></div>
